...
export const DATA = {
  ...
  summary:
    "Highly motivated and dependable professional with a diverse background in building scalable Web App. Despite limited work experience, I bring a strong work ethic, adaptability, and a commitment to excellence. With a proven track record of reliability and a dedication to continuous learning.",
  avatarUrl: "/me.png",
  skills: [
    "React",
    "Typescript",
  ...
  // ],
  contact: {
    email: "yadavshiva8755@gmail.com",
    tel: "+123456789",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/shiva8081",
        icon: Icons.github,
        navbar: true,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://linkedin.com/in/shiva8081",
        icon: Icons.linkedin,
        navbar: true,
      },
      X: {
        name: "X",
        url: "https://x.com/Shiva_8081",
        icon: Icons.x,
        navbar: true,
      },
      Email: {
        name: "Send Email",
        url: "mailto:yadavshiva8755@gmail.com",
        icon: Icons.email,
        navbar: true,
      },
    },
